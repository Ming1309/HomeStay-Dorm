...
public sealed record TaoTaiKhoanHttpRequest(string MaNV, string HoTen, string SDT, string VaiTro, string MaCN, string TenDangNhap, string Email, string MatKhauTam);
