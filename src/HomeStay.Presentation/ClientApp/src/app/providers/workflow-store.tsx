...
import { useAuth, type UserRole } from "@/features/auth/model/auth-store";
import { mockAppointments } from "@/features/appointments/model/mock-appointments";
import { mockRooms } from "@/features/rooms/model/mock-rooms";

export type { UserRole } from "@/features/auth/model/auth-store";
...
export function WorkflowProvider({ children }: { children: ReactNode }) {
  const { role, isHydrated, setRole } = useAuth();
