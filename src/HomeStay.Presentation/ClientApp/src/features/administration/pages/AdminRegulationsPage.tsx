    ...
    <div className="h-full w-full overflow-hidden bg-gray-50">
      <section className="flex h-full flex-col">
        ...
        <footer className="flex h-12 items-center justify-between border-t border-gray-200 bg-white px-6 text-xs text-gray-500">
          <span>
            <kbd className="rounded border bg-gray-50 px-1.5 py-0.5 text-[10px]">Ctrl</kbd> +{" "}
            <kbd className="rounded border bg-gray-50 px-1.5 py-0.5 text-[10px]">N</kbd> : Thêm quy
            định
          </span>
