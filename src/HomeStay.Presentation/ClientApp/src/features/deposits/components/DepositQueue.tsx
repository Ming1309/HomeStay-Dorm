    ...
    <aside className="flex h-full w-[350px] shrink-0 flex-col border-r border-gray-200 bg-white">
      ...
      <div className="sticky top-0 z-10 border-b border-gray-100 bg-white px-3 py-2">
        <div className="relative">
          ...
          <Input onChange={(e) => onSearch(e.target.value)} placeholder="Tìm phiếu..." className="h-8 pl-8 text-xs" />
        </div>
      </div>
      <div className="flex-1 overflow-y-auto">
        {loading ? (
          ...
          <div className="p-6 text-center text-sm text-gray-400">Không có phiếu cọc nào chờ tính tiền.</div>
        ) : (
